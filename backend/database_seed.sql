...
('prof001', 'usr002', 'PROF001', 'María', 'García López', 'CC', '1098765432', '1990-05-15', 'Femenino', 'Cra 12 #18-30', 'Neiva', '3201234567', 'maria.garcia@huellasdelsaber.edu.co', 'maria.garcia@gmail.com', 'Pedro García', '3109876543', 'Profesional', 'Licenciada en Pedagogía Infantil', 'Universidad Surcolombiana', 'Primera Infancia', 8, 'Pedagogía Infantil', '2018-02-01', 'Indefinido', 2500000, 'Activo', '["Jardín"]', TRUE, TRUE),
...
('est001', 'EST001', 'Tarjeta de Identidad', '1234567890', 'Juan Sebastián', 'Rodríguez Pérez', '2020-03-15', 'Masculino', 'Párvulos', 'Activo', 'Cra 5 #12-34', 'Centro', '3201234567', 'O+', 'Salud Total', 'Ninguna', NULL, '2023-01-10', '2024-01-15', TRUE),
...
('est005', 'EST005', 'Registro Civil', '654321098', 'Miguel Ángel', 'Hernández Castro', '2020-11-12', 'Masculino', 'Párvulos', 'Activo', 'Cra 20 #25-15', 'Altico', '3112345678', 'A-', 'Sura', 'Polen', NULL, '2023-01-20', '2024-01-22', TRUE),
...
-- ========================================
-- HORARIOS (Nivel Párvulos - Lunes)
-- ========================================
INSERT INTO horarios (id, nivel, dia_semana, hora_inicio, hora_fin, materia, tipo_actividad, profesor_id, aula, color) VALUES
('hor001', 'Párvulos', 1, '07:30:00', '08:30:00', 'Bienvenida y Rutina', 'Académica', 'prof001', 'Aula 1', '#3b82f6'),
('hor002', 'Párvulos', 1, '08:30:00', '09:30:00', 'Dimensión Cognitiva', 'Académica', 'prof001', 'Aula 1', '#8b5cf6'),
('hor003', 'Párvulos', 1, '09:30:00', '10:00:00', 'Refrigerio', 'Descanso', 'prof001', 'Comedor', '#10b981'),
('hor004', 'Párvulos', 1, '10:00:00', '11:00:00', 'Dimensión Comunicativa', 'Académica', 'prof001', 'Aula 1', '#f59e0b'),
('hor005', 'Párvulos', 1, '11:00:00', '12:00:00', 'Educación Física', 'Física', 'prof003', 'Patio', '#ef4444'),
('hor006', 'Párvulos', 1, '12:00:00', '13:00:00', 'Almuerzo', 'Almuerzo', 'prof001', 'Comedor', '#06b6d4'),
('hor007', 'Párvulos', 1, '13:00:00', '14:00:00', 'Arte y Creatividad', 'Artística', 'prof001', 'Aula 1', '#ec4899'),
('hor008', 'Párvulos', 1, '14:00:00', '15:00:00', 'Juego Libre', 'Descanso', 'prof001', 'Patio', '#84cc16');

-- Martes
INSERT INTO horarios (id, nivel, dia_semana, hora_inicio, hora_fin, materia, tipo_actividad, profesor_id, aula, color) VALUES
('hor009', 'Párvulos', 2, '07:30:00', '08:30:00', 'Bienvenida y Rutina', 'Académica', 'prof001', 'Aula 1', '#3b82f6'),
('hor010', 'Párvulos', 2, '08:30:00', '09:30:00', 'Matemáticas', 'Académica', 'prof001', 'Aula 1', '#8b5cf6'),
('hor011', 'Párvulos', 2, '09:30:00', '10:00:00', 'Refrigerio', 'Descanso', 'prof001', 'Comedor', '#10b981'),
('hor012', 'Párvulos', 2, '10:00:00', '11:00:00', 'Lecto-escritura', 'Académica', 'prof001', 'Aula 1', '#f59e0b'),
('hor013', 'Párvulos', 2, '11:00:00', '12:00:00', 'Música', 'Artística', 'prof001', 'Aula 1', '#ec4899'),
('hor014', 'Párvulos', 2, '12:00:00', '13:00:00', 'Almuerzo', 'Almuerzo', 'prof001', 'Comedor', '#06b6d4');
...
('evt001', 'Día de la Familia', 'Celebración del día de la familia con actividades recreativas', '2024-12-15', '08:00:00', '12:00:00', 'Festivo', 'Instalaciones del colegio', '["Caminadores", "Párvulos", "Prejardín", "Jardín", "Párvulos"]', 'usr001', 'Importante'),
('evt002', 'Reunión de Padres - Párvulos', 'Entrega de boletines primer periodo', '2024-12-10', '14:00:00', '16:00:00', 'Reunión', 'Aula 1', '["Párvulos"]', 'usr002', 'Importante'),
('evt003', 'Navidad en el Colegio', 'Celebración navideña con presentaciones artísticas', '2024-12-20', '09:00:00', '13:00:00', 'Ceremonia', 'Auditorio', '["Caminadores", "Párvulos", "Prejardín", "Jardín", "Párvulos"]', 'usr001', 'Urgente'),
...
('evt005', 'Evaluación Período 4', 'Inicio de evaluaciones finales', '2024-12-02', NULL, NULL, 'Evaluación', NULL, '["Caminadores", "Párvulos", "Prejardín", "Jardín", "Párvulos"]', 'usr001', 'Normal');
...
('rec001', 'Guía de Lectoescritura', 'Material completo para enseñanza de vocales y consonantes', 'documento', '/recursos/lectoescritura-guia.pdf', 'Párvulos', 'Lenguaje', 'Lenguaje y Comunicación', 'prof001', '2.5 MB', 15, 45, TRUE, FALSE, '["lectura", "escritura", "vocales"]', TRUE, FALSE),
...
('rec003', 'Video: El Ciclo del Agua', 'Explicación animada del ciclo del agua', 'video', 'https://youtube.com/ejemplo-agua', 'Párvulos', 'Ciencias', 'Ciencias Naturales', 'prof002', '50 MB', 8, 34, FALSE, TRUE, '["agua", "naturaleza", "ciencia"]', TRUE, TRUE),
